...
class App extends Component {
  ...
  render() {
    if(this.state.firebaseUser!==null && this.state.user!==null){
      ...
      <body>
      <div>
        <Header history={customHistory} typeUser={this.state.user.typeUser} activeUser={this.state.user} userAvatar={this.state.firebaseUser.providerData[0].photoURL} loggedState={this.state.userLogged} />
        <MuiThemeProvider muiTheme={muiTheme}>
  <Router history={customHistory} callbackFromParentHome ={this.myCallbackHome}>     
      <Switch>
        <Route path="/Registro" component={()=> <Registro typeUser={this.state.user.typeUser} history={customHistory} activeUser={this.state.user}/>} />
        <Route path="/RegistroProfesor" component={()=> <RegistroProfesor typeUser={this.state.user.typeUser} history={customHistory} activeUser={this.state.user}/>} />
        <Route path="/Prueba" component={()=> <Prueba typeUser={this.state.user.typeUser} history={customHistory} activeUser={this.state.user}/>} />
        <Route path="/Enunciado" component={()=> <Enunciado typeUser={this.state.user.typeUser} history={customHistory} activeUser={this.state.user}/>} />
        <Route path="/Solucion" component={()=> <Solucion typeUser={this.state.user.typeUser} history={customHistory} activeUser={this.state.user}/>}  />
        <Route path="/Code" component={()=> <CodeMirror typeUser={this.state.user.typeUser} history={customHistory} activeUser={this.state.user}/>} />
    <Route path= "/Login2" component={()=> <Login2 typeUser={this.state.user.typeUser} callbackFromParentLogin ={this.myCallbackLogin} history={customHistory}/>}/>
        <Route path="/Home" component={()=> <Home typeUser={this.state.user.typeUser} callbackFromParentHome ={this.myCallbackHome} history={customHistory} callbackFromParentHomeUser ={this.myCallbackHomeUser}/>} />
        <Route path="/CrearCurso" component={()=><CrearCurso typeUser={this.state.user.typeUser} history={customHistory} activeUser={this.state.user}/>}/>
        <Route path="/verEnunciado" component={()=><verEnunciado typeUser={this.state.user.typeUser} history={customHistory} activeUser={this.state.user}/>}/>
        <Route path="/ListarEnunciados" component={()=><ListarEnunciados typeUser={this.state.user.typeUser} history={customHistory} activeUser={this.state.user}/>}/>
    ...
    return (
      <body>
      <div>
        <Header history={customHistory} loggedState={false}/>
        <MuiThemeProvider muiTheme={muiTheme}>
  <Router history={customHistory} callbackFromParentHome ={this.myCallbackHome}>     
      <Switch>
