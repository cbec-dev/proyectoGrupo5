  ...
  render() {
   ...
   if(this.props.typeUser===1||this.props.typeUser===2){
        ...
        return (
          ...
          <div>
          <Panel className="panelE" alt= "50x50">
            ...
            <p>
              ...
              <div className="container-button">
                ...
                <Button className="button1" eventKey={3.6} href="#">
                 ...
                 <LinkContainer to={{ pathname: '/Solucion', state: { statement: statement, typeUser: this.props.typeUser, activeUser: this.props.activeUser} }}>
                <Button className="button1" eventKey={3.6} href="#">
                    Subir Solucion
                </Button>
                 </LinkContainer>
