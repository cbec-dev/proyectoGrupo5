...
class CrearCurso extends Component {
    ...
    agregarProfesor(profesor, section){
        ...
        fetch('http://209.97.152.30:8080/frontendGrupo5/sections/update/'+profesor+'/'+section.idSection)
                .then(response => fetch('http://209.97.152.30:8080/frontendGrupo5/sections/allSection')
    ...
    removeProfesor(e){
        ...
        fetch('http://209.97.152.30:8080/frontendGrupo5/sections/removeP/'+section.idSection)
            .then(response => this.setState({response: response, isLoading: true}))
            .then(alert("Profesor removido correctamente"))
            .then(fetch('http://209.97.152.30:8080/frontendGrupo5/sections/allSection')
            .then(response => response.json())
            .then(data => this.setState({sections: data, isLoading: false}))) 
    ...
    subirFormulario(e) {
        ...
        if(this.section.sectionName ===""){
            ...
            this.limpiarValores(1);
            fetch('http://209.97.152.30:8080/frontendGrupo5/sections/addSection?sectionName='+this.section.sectionName)
    ...
    componentDidMount(){
        fetch('http://209.97.152.30:8080/frontendGrupo5/sections/allSection')
            ...
            .then(fetch('http://209.97.152.30:8080/frontendGrupo5/users/searchtype/'+3)
            .then(response => response.json())
